...
## revised by hakk ##
### there is no rcs in dataset, so i changed rcs into power. ###
...
# Paths (customizable)
RADAR_ROOT = "./WaterScenes/radar" # Your own radar csv path
SAVE_RADAR_MAP_ROOT = "./WaterScenes/radar/REVP_radar" # New dir to save npz
